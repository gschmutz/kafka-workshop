...
public class KafkaStreamsRunnerCountSessionWindowedSuppressedDSLTest {
    ...
    void test30SecGapWithNoGracePeriod_AllInOrder() {
        ...
        // start at 09:00:00
        inputTopic.pipeInput(KEY, "cat", TS_09_00_00.toEpochMilli());
        // still within inactivity gap
        inputTopic.pipeInput(KEY, "dog", TS_09_00_15.toEpochMilli());
        // after activity gap so window will close with 09:00:15 and new one starts with 09:00:46
        inputTopic.pipeInput(KEY, "foo", TS_09_00_46.toEpochMilli());
        // still within inactivity gap
        inputTopic.pipeInput(KEY, "foo", TS_09_00_47.toEpochMilli());
        // end previous session window
        inputTopic.pipeInput(KEY, "foo", TS_END.toEpochMilli());
    ...
    void test30SecGapWithNoGracePeriod_WithLateArrival() {
        ...
        inputTopic.pipeInput(KEY, "foo", TS_09_00_16.toEpochMilli());
        // end previous session window
        inputTopic.pipeInput(KEY, "foo", TS_END.toEpochMilli());
    ...
    void test30SecGapWithNoGracePeriod_WithLateArrivalSameAsWindowEnd() {
        ...
        inputTopic.pipeInput(KEY, "foo", TS_09_00_15.toEpochMilli());
        // end previous session window
        inputTopic.pipeInput(KEY, "foo", TS_END.toEpochMilli());
    ...
    void test30SecGapWith15SecGracePeriod_WithLateArrival() {
        ...
        inputTopic.pipeInput(KEY, "foo", TS_09_00_17.toEpochMilli());
        // end previous session window
        inputTopic.pipeInput(KEY, "foo", TS_END.toEpochMilli());
