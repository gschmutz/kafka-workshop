...
public class KafkaStreamsRunnerCountSessionWindowedCustomSuppressWithProcessorDSL {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, StateValue> sessionedStream = counts.toStream().process(new SuppressWindowProcessor(myStateStore), myStateStore.name());
        ...
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "countSessionWindowedCustomSuppressed33");
