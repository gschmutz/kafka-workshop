...
In this workshop we will learn how to handle consumer-side error situations when working with the **Spring Kafka** abstraction from within a Spring Boot application. We will implement a consumer and show various error cases and how to work around them. 
