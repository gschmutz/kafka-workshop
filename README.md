...
5c | [Kafka Heterogenous Topic from Spring Boot with Avro IDL & Schema Registry](./05c-working-with-hererogenous-topic-avro-idl-and-springboot)  | learn how to use **Spring Boot** to consume and produce from/to Kafka using a heterogenous topic (to transport different Avro objects) using Avro IDL.
